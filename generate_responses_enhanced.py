...
# python generate_responses_enhanced.py --model_path=./models/enhanced_recommender/final/experi/seq_pretrain/model_best --save_path=./experiment_generated/pretrain_.txt
def get_movies(path):
    # 載入電影資料
    id2name = {}
    db2id = {}
...
if __name__ == '__main__':
    ...
    #GT rec times, take recommended cases for testing 
    rec_GT_conv = []
